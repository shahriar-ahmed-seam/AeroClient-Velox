export namespace model {
	...
	export class BodySpec {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.type = source["type"];
	        this.raw = source["raw"];
	        this.formFields = this.convertValues(source["formFields"], KeyValue);
	    }
	...
	export class SavedRequest {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.auth = this.convertValues(source["auth"], AuthSpec);
	        this.id = source["id"];
	...
	export class HistoryEntry {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.at = source["at"];
	        this.error = source["error"];
	        this.request = this.convertValues(source["request"], RawRequest);
	    }
